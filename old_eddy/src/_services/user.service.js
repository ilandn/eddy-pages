...
function play() {
	...
	try{
		xhttp.open("GET", "http://54.145.214.70:8080/eddy/eddy/api/play", false);
		...
		if (xhttp.status === 200) {
			...
			return Promise.reject(xhttp.status);
	}
	catch(error){
...
//        });
    ...
    xhttp.open("POST", "http://54.145.214.70:8080/eddy/eddy/api/login", false);
