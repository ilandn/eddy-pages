...
function Questions(questions, questionUI) {
		...
		this.rightAnswer = function (){
		    return String(this.currentQuestion.data.correctAnswer);
		};
		...
		this.newQuestion = function(){
			...
			if (this.questionIdx < this.length){
				...
				if (this.currentQuestion.type == 'MULTIPLE_CHOICE'){
						this.currentAnswers  = this.currentQuestion.data.answers.map(String); //.split(",").map(Function.prototype.call, String.prototype.trim);
